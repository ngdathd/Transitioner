package com.animation.transitioner.kotlin
    ...
    fun setProgress(progress: Float) {
        ...
        mappedViews.forEach {
            it.apply {
                ...
                startV.layoutParams.width =
                    origDimens.width + ((endV.width - origDimens.width) * progress).toInt()
                startV.layoutParams.height =
                    origDimens.height + ((endV.height - origDimens.height) * progress).toInt()
